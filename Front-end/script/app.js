...
const get_data_speedrun = function (difficulty, buttons) {
  ...
  handleData(url, LoadScoreBoardSpeedrun);
};
...
const HomePage = function () {
  ...
  btnScoreBoardArrowLeft.addEventListener('click', function () {
  ...
  btnScoreBoardArrowRight.addEventListener('click', function () {
  ...
  btnScoreBoardPlayButton.addEventListener('click', function () {
    console.log('Scoreboard play button clicked');
    if (pauseScroll == false) {
      pauseScroll = true;
      btnScoreBoardPlayButton.src = './img/Play-Icon.svg';
    } else {
      pauseScroll = false;
      btnScoreBoardPlayButton.src = './img/Pause-Icon.svg';
    }
  });
...
LoadScoreBoardPodium1vs1 = function (players) {
  scoreBoardTitle.innerHTML = `Scoreboard <u>1VS1</u>`;
  scoreBoardFirstPlace.innerHTML = 'Leeg';
  scoreBoardSecondPlace.innerHTML = 'Leeg';
  scoreBoardThirdPlace.innerHTML = 'Leeg';
  if (players[0] != undefined) {
    scoreBoardFirstPlace.innerHTML = `${players[0].winnaar}`;
  }
  if (players[1] != undefined) {
    scoreBoardSecondPlace.innerHTML = `${players[1].winnaar}`;
  }
  if (players[2] != undefined) {
    scoreBoardThirdPlace.innerHTML = `${players[2].winnaar}`;
  }
...
LoadScoreBoardPodiumSimonSays = function (players) {
  scoreBoardTitle.innerHTML = `Scoreboard <u>Simon Says</u>`;
  scoreBoardFirstPlace.innerHTML = 'Leeg';
  scoreBoardSecondPlace.innerHTML = 'Leeg';
  scoreBoardThirdPlace.innerHTML = 'Leeg';
  if (players[0] != undefined) {
...
LoadScoreBoardPodiumSpeedrun = function (players) {
  scoreBoardTitle.innerHTML = `Scoreboard <u>Speedrun</u>`;
  scoreBoardFirstPlace.innerHTML = 'Leeg';
  scoreBoardSecondPlace.innerHTML = 'Leeg';
  scoreBoardThirdPlace.innerHTML = 'Leeg';
  if (players[0] != undefined) {
...
LoadScoreBoardPodiumShuttleRun = function (players) {
  scoreBoardTitle.innerHTML = `Scoreboard <u>Shuttle Run</u>`;
  scoreBoardFirstPlace.innerHTML = 'Leeg';
  scoreBoardSecondPlace.innerHTML = 'Leeg';
  scoreBoardThirdPlace.innerHTML = 'Leeg';
  if (players[0] != undefined) {
...
LoadScoreBoard = function (players) {
  console.log(players);
  // First place
  placeHolderScoreBoardPlayers.innerHTML = '';
  if (players.length > 0) {
    placeHolderScoreBoardPlayers.innerHTML = `<div class="c-player c-first-player">
  ...
  // Second place
  if (players.length > 1) {
    placeHolderScoreBoardPlayers.innerHTML += `<div class="c-player c-second-player">
        <div class="c-player-number">
  ...
  // Third place
  if (players.length > 2) {
    placeHolderScoreBoardPlayers.innerHTML += `<div class="c-player c-third-player">
        <div class="c-player-number">
  ...
  players.forEach((player) => {
    if (place > 3) {
      placeHolderScoreBoardPlayers.innerHTML += `<div class="c-player">
            <div class="c-player-number">
                <h3>${place}</h3>
            </div>
            <div class="c-player-name">
...
LoadScoreBoardSpeedrun = function (players) {
  console.log(players);
  // First place
  placeHolderScoreBoardPlayers.innerHTML = '';
  if (players.length > 0) {
...
//#region ***  get  ***********
GetScoreBoardPodium1vs1 = function () {
  jsonBody = {
    firstplace: 'Tibo',
    secondplace: 'Tjörven',
    thirdplace: 'Lander',
...
GetScoreBoardPodiumSimonSays = function () {
  jsonBody = {
    firstplace: 'Ibe',
    secondplace: 'Doran',
    thirdplace: 'Capser',
...
GetScoreBoardPodiumSpeedrun = function () {
  jsonBody = {
    firstplace: 'Niels',
    secondplace: 'Eric',
    thirdplace: 'Steve',
...
GetScoreBoardPodiumShuttleRun = function () {
  jsonBody = {
    firstplace: 'Lander',
    secondplace: 'Tibo',
    thirdplace: 'Tjörven',
...
const init = function () {
  ...
  //Score bord
  scoreBoardTitle = document.querySelector('.js-score-bord-title');
  scoreBoardFirstPlace = document.querySelector('.js-throphy-gold__name');
  scoreBoardSecondPlace = document.querySelector('.js-throphy-silver__name');
  scoreBoardThirdPlace = document.querySelector('.js-throphy-bronze__name');
  gameSquares = document.querySelectorAll('.js-game-square');
  btnScoreBoardArrowLeft = document.querySelector('.js-score-bord-arrow-left');
  btnScoreBoardArrowRight = document.querySelector(
    '.js-score-bord-arrow-right'
  );
  btnScoreBoardPlayButton = document.querySelector('.js-score-bord-play-btn');
  ...
  placeHolderScoreBoardPlayers = document.querySelector('.js-grid-players');
